    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center px-4">
            ...
            <p className="text-center text-sm text-gray-700 max-w-md mb-6">
                Una vez confirmada tu compra, se enviará un correo con la información del pago.
                Por favor revisa también tu bandeja de spam.
            </p>
            ...
            {assignedNumbers.length > 0 ? (
                ...
                <p className="text-gray-500 mb-6">Cargando tus números asignados...</p>
            )}
